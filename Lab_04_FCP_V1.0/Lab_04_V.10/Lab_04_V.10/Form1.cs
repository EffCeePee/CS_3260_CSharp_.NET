...
namespace Employee_Form
{
    ...
    public partial class Form_Employee : Form
    {
        ...
        {
            test = Business_Rules.Rules.getEmp();
            ...
            switch (newEmp)
            {
                case ETYPE.Hourly:
                    ...
                    } else 
                    {
                        ...
                        Business_Rules.Rules.addEmpHourly(Convert.ToInt32(txt_empID.Text), ETYPE.Hourly, txt_empName.Text, Convert.ToDecimal(txt_info2.Text), Convert.ToDouble(txt_info1.Text));
                    _message =  _success;
                ...
                case ETYPE.Salary:
                    ...
                    Business_Rules.Rules.addEmpSalary(Convert.ToInt32(txt_empID.Text), ETYPE.Salary, txt_empName.Text, Convert.ToDecimal(txt_info1.Text));
                    _message =  _success;
                    MessageBox.Show(_message);
                ...
                case ETYPE.Contract:
                    ...
                    else if (txt_info1.Text == "")
                    {
                     ...
                     Business_Rules.Rules.addEmpContract(Convert.ToInt32(txt_empID.Text), ETYPE.Contract, txt_empName.Text, Convert.ToDecimal(txt_info1.Text));
                    _message =  _success;
                    MessageBox.Show(_message);
                ...
                case ETYPE.Sales:
                    ...
                    Business_Rules.Rules.addEmpSales(Convert.ToInt32(txt_empID.Text), ETYPE.Sales, txt_empName.Text, Convert.ToDecimal(txt_info2.Text), Convert.ToDecimal(txt_info1.Text), Convert.ToDecimal(txt_info3.Text));
                    _message =  _success;
                    MessageBox.Show(_message);
                    break;
