    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Comment or uncomment the method calls below to run or not
              ...
              Console.ReadKey();
              samples.Linq61(); // This sample uses FirstOrDefault to try to return the first element of the sequence, unless there are  no elements,  in which case  the default  value for that type is returned.  FirstOrDefault is useful for creating outer joins
              Console.ReadKey();
        ...
        class LinqSamples
        {
            ...
            public void Linq64()
            {
                ...
                int fourthLowNum = (from num in numbers
                                        where num > 5
                                            select num).ElementAt(1);  // second number is index 1 because sequences use 0-based indexing
