    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            samples.Linq92(); // This sample uses Aggregate to create a running product on the array that calculates -- the total product of all elements
              Console.ReadKey();
            samples.Linq93(); // This sample uses Aggregate to create a running account balance that subtracts each -- withdrawal from the initial balance of 100, as long as the balance never drops below 0
              Console.ReadKey();
        }
