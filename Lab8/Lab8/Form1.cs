                ...
                switch (newEmp)
                {
                    case ETYPE.Hourly:
                        ...
                        else
                        {
                            ...
                            Business_Rules.Rules.addEmpHourly(Convert.ToUInt32(txt_empID.Text), ETYPE.Hourly, txt_empName.Text, Convert.ToDecimal(txt_info2.Text), Convert.ToDouble(txt_info1.Text),false,false,false,false);
                            _message = _success;
                        }
                    ...
                    case ETYPE.Salary:
                        ...
                        Business_Rules.Rules.addEmpSalary(Convert.ToUInt32(txt_empID.Text), ETYPE.Salary, txt_empName.Text, Convert.ToDecimal(txt_info1.Text), false, false, false, false);
                        _message = _success;
                        MessageBox.Show(_message);
                    ...
                    case ETYPE.Contract:
                        ...
                        Business_Rules.Rules.addEmpContract(Convert.ToUInt32(txt_empID.Text), ETYPE.Contract, txt_empName.Text, Convert.ToDecimal(txt_info1.Text),false,false,false,false);
                        _message = _success;
                        MessageBox.Show(_message);
                    ...
                    case ETYPE.Sales:
                        ...
                        Business_Rules.Rules.addEmpSales(Convert.ToUInt32(txt_empID.Text), ETYPE.Sales, txt_empName.Text, Convert.ToDecimal(txt_info2.Text), Convert.ToDecimal(txt_info1.Text), Convert.ToDecimal(txt_info3.Text),false,false,false,false);
                        _message = _success;
                        MessageBox.Show(_message);
                        break;
