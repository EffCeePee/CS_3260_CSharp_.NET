...
namespace employee
{
    ...
    class Business_Rules
    {
        ...
        /// <param name="hr"></param>
        /// <param name="hw"></param>
        public void addEmpHourly(uint i, ETYPE et, string fn, string ln, decimal hr, double hw, bool ot, bool ben, bool comm, bool edBen)
        {
            if (empDictionary == null)
            {
                empDictionary = new SortedDictionary<uint, Employee>();
                newhrly = new Hourly(i, et, fn, ln, hr, hw, ot, ben, comm, edBen);
        ...
        /// <param name="gs"></param>
        /// <param name="ms"></param>
        public void addEmpSales(uint i, ETYPE et, string fn, string ln, decimal cs, decimal gs, decimal ms, bool ot, bool ben, bool comm, bool edBen)
        {
            if (empDictionary == null)
            {
                empDictionary = new SortedDictionary<uint, Employee>();
                newsles = new Sales(i, et, fn, ln, cs, gs, ms, ot, ben, comm, edBen);
        ...
        /// <param name="en"></param>
        /// <param name="cs"></param>
        public void addEmpContract(uint i, ETYPE et, string fn, string ln, decimal cs, bool ot, bool ben, bool comm, bool edBen)
        {
            if (empDictionary == null)
            {
                empDictionary = new SortedDictionary<uint, Employee>();
                newContract = new Contract(i, et, fn, ln, cs, ot, ben, comm, edBen);
