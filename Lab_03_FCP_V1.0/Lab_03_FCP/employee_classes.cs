...
namespace employee
{
    ...
    abstract class Employee : Object
    {
        ...
        /// </summary>
        public Employee(int i, string et, string en)
        {
            _EmpID = i; 
            _EmpType = et;
            _EmpName = en;
    ...
    sealed class Hourly : Employee
    {
        ...
        /// <param name="hr"></param>
        /// <param name="hw"></param>
        public Hourly(int i, string et, string en, decimal hr, double hw)
        {
            _EmpID = i; 
            _EmpType = et;
            _EmpName = en;
    ...
    sealed class Contract : Employee
    {
        ...
        /// <param name="en"></param>
        /// <param name="cs"></param>
        public Contract(int i, string et, string en, decimal cs)
        {
            _EmpID = i; 
            _EmpType = et;
            _EmpName = en;
    ...
    class Salary : Employee
    {
        ...
        /// <param name="en"></param>
        /// <param name="ms"></param>
        public Salary(int i, string et, string en, decimal ms)
        {
            _EmpID = i; 
            _EmpType = et;
            _EmpName = en;
    ...
    sealed class Sales : Salary
    {
        ...
        /// <param name="gs"></param>
        /// <param name="ms"></param>
        public Sales(int i, string et, string en, decimal cs, decimal gs, decimal ms)
        {
            _EmpID = i; 
            _EmpType = et;
            _EmpName = en;
